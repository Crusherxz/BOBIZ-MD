...
module.exports = {
    ...
    URL_1LINK: process.env.URL_1LINK === undefined ? 'https://instagram.com/crusher__xz' : process.env.URL_1LINK,
    ...
    FOOTER: process.env.FOOTER === undefined ? 'BOBIZBOT-MD  https://instagram.com/crusher__xz تابعني على الانستغرام ' : process.env.FOOTER,
    CAPTION: process.env.CAPTION === undefined ? 'CRUSHERXZ 𝙱𝙾𝚃 𝙼𝙳 https://instagram.com/crusher__xz  ' : process.env.CAPTION,
    ALIVEMSG: process.env.ALIVE_MESSAGE === undefined ? 'default' : process.env.ALIVE_MESSAGE,
    ALIVE_LOGO: process.env.ALIVE_LOGO === undefined ? 'https://telegra.ph/file/07d8bbc06cf537002230a.jpg' : process.env.ALIVE_LOGO,
    ...
    STIC_WM:process.env.STIC_WM === undefined ? 'CRUSHERX BOT' : process.env.STIC_WM,
};
